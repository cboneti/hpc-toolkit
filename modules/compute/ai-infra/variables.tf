...
variable "instance_image" {
  ...
  default = {
    family  = "pytorch-1-12-cu113-debian-10"
...
variable "install_nvidia_driver" {
  description = "Installs the nvidia driver"
  type        = bool
}
...
variable "enable_google_monitoring" {
  description = "Enables Google Cloud Operations Monitoring in images that come preconfigured with the agent.g"
  type        = bool
  default     = false
}
